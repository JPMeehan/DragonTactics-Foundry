  ...
  _prepareHeroData(actorData) {
    ...
    for (let [key, power] of Object.entries(data.powers)) {
      ...
      if (filters) {
        ...
        if (data.powerfilters.standard || 
          data.powerfilters.move || 
          data.powerfilters.minor || 
          data.powerfilters.immediate || 
          data.powerfilters.free) {
          ...
          actionfilter = data.powerfilters[action]
        }
